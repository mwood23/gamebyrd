...
angular
	.module('app')
		.controller('main', ['$scope', function($scope, $route, $routeParams, $location){
			console.log(hello)
			...
			var Console = function(name, description, price, image){
				...
				this.price = price;
				this.image = image;
				$scope.consoleLibrary.push(this)
			}
			...
			var Bundle = function(console, games, price, image){
				...
				this.price = price;
				this.image = image;
				$scope.bundles.push(this)
			}

			// Consoles
			$scope.nintendo64 = new Console(
				'Nintendo 64',
			...
			$scope.playstation4 = new Console(
				'Playstation 4',
			...
			$scope.supernintendo = new Console(
				'Super Nintendo',
			...
			$scope.metalgearsolid5 = new Game (
				...
				[$scope.playstation4.name, $scope.xboxone.name],
				10,
				'http://ecx.images-amazon.com/images/I/91%2BwlIt-vDL._SL1500_.jpg'
				)
			$scope.supermarioworld = new Game (
				'Super Mario World',
			...
			$scope.supersmashbroswiiu = new Game (
